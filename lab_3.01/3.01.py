...
if __name__ == "__main__":
    ...
    arrow = [(2.4, 2), (5.9, 4), (9.9, 6), (16.5, 8), (22.4, 10), (27.1, 12)]
    ring = [(2.1, 2), (5.7, 4), (9.2, 6), (22, 8), (24.2, 10), (28.1, 12)]
    ...
    report.add_custom_latex(r"В результате выполнения лабораторной работы"
                            ...
                            r" раз ближе к верхней половине установки. Также во время выполнения данной "
                            r"лабораторной работы"
                            r" соседний стенд для выполнения 13-ой лабораторной использовался другой командой,"
                            r" что тоже могло привести к подобным искривлениям. \\ На графике зависимости потенциала $\phi$"
                            r"от икса для кольца и плоского конденсатора также видно искривление одной из частей,"
                            r"поскольку с аналитической точки зрения график для конденсатора должен быть более"
                            r"прямым, а график кольца должен быть нечетной функций относительно графика конденсатора"
                            r" (должна получаться анти симметричность). Расчитанные погрешности не имеют особых всплесков."
                            r"")
